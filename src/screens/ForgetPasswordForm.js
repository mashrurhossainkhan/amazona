...
import { forget_password_exist_user, forget_password_verificaion_code } from '../action/userAction';
...
const ForgetPasswordForm = (props) => {
    ...
    const userForgerPassword = useSelector((state) => state.userExistForForgetPass);
