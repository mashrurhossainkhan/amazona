            ...
            {cartItems.length === 0 ? (
                ...
                <ul>
                    {cartItems.map((item) => (
                        ...
                        <li key={item.product}>
                            <div className="row" 
                            style={{backgroundColor: "#ffffff", padding: "3px", borderRadius: "1.2rem"}}>
                                <div>
                                    <img 
                                ...
                                <div className="min-30"> 
                                    <Link style={{color: "#000000"}} to={`/product/${item.product}`}>
                                        {item.name.slice(0,40)}...</Link>
                                ...
                                <div>
                                    <select
                                    style={{backgroundColor: "#D1DEEB", border: "2px solid #D1DEEB"}}
                                        value={item.qty}
                                        onChange={(e) => 
                                            dispatch(
                                    ...
                                    >
                                         {[...Array(item.countInStock).keys()].map(//if the count = 5, it will return 0 to 4
                                            (x) => (
                                    ...
                                    <DeleteOutlineIcon fontSize="large" style={{cursor: "pointer"}}
        ...
        <div className="col-1-displayed">
            <div className="card card-body">
                <ul>
                    <li>
                        <h2>
                            Subtotal: ({cartItems.reduce((a,c)=> a+c.qty,0)} items): BDT
