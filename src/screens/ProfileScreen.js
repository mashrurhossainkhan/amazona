...
export default function ProfileScreen() {
  ...
  const [loadingUploadsellerHomeCat1Img, setLoadingUploadsellerHomeCat1Img] =
    useState(false);
  const [errorUploadsellerHomeCat1Img, setErrorUploadsellerHomeCat1Img] =
    useState('');

  const [loadingUploadsellerHomeCat2Img, setLoadingUploadsellerHomeCat2Img] =
    useState(false);
  const [errorUploadsellerHomeCat2Img, setErrorUploadsellerHomeCat2Img] =
    useState('');

  const [loadingUploadsellerHomeCat3Img, setLoadingUploadsellerHomeCat3Img] =
    useState(false);
  const [errorUploadsellerHomeCat3Img, setErrorUploadsellerHomeCat3Img] =
    useState('');
              ...
              <>
                ...
                <div>
                  <label htmlFor="imageFile">
                    Image File for Seller Banner(maximum 7 images,height:450px)
                  </label>
                  <input
                    type="file"
                    id="imageFile"
                ...
                <div>
                  <div>
                    <label htmlFor="Pre 10 Percent Enable">
                      Pre 10 Percent Enable :{' '}
                    </label>
                    <Checkbox
                  ...
                  {loadingCategories ? (
                    ...
                    <>
                      ...
                      <div>
                        ...
                        ></input>
                        <div>
                          {loadingUploadsellerHomeCat1Img && (
                            <LoadingBox></LoadingBox>
                          )}
                      ...
                      <div>
                        ...
                        ></input>
                        <div>
                          {loadingUploadsellerHomeCat2Img && (
                            <LoadingBox></LoadingBox>
                          )}
                      ...
                      <div>
                        <select
                          value={sellerHomeCat3}
                          onChange={(e) => clickCatHome3(e)}
                        >
                          {/*make a function to set category and dispatch*/}
                          <option>Choose category</option>
                          {categories.map((c, index) => (
                        ...
                        ></input>
                        <div>
                          {loadingUploadsellerHomeCat3Img && (
                            <LoadingBox></LoadingBox>
                          )}
