...
const Verification_Customer = () => {
    var retrieve_Reg_Page1Obj = localStorage.getItem('userInfo');//getting user info
    var retrieve_Reg_Page1Obj_main= JSON.parse(retrieve_Reg_Page1Obj);
    const [retrieve_Reg_Page1Obj_main_state, set_retrieve_Reg_Page1Obj_main] = useState(retrieve_Reg_Page1Obj_main);
    ...
    const Verification_form = () =>{       
            return(
                ...
                <p className='Tabs_Head'> <br/> Account</p>
                <h3 className="Tabs_Head">Verification Code</h3>
                <form className="form" onSubmit={handleSubmit}>
                <div >
               
                    <input type="number" name="otp" value={otpInput1} autoFocus="autoFocus"
                        onChange={(e)=>OTPVal(e)}
                    ></input>
    ...
    return(
        <div className="marchant_page_common_css">
            {retrieve_Reg_Page1Obj_main_state ? 
                 <Verification_form/>
...
export default Verification_Customer;